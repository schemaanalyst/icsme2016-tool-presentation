 \begin{frame}
	 \frametitle{Installation}
        ...
        \centering
	\begin{enumerate}
		\only<1->{ \item \texttt{git clone git@github.com:schemaanalyst-team/schemaanalyst.git}}
		\only<2->{ \item \texttt{./gradlew compile}}
		\only<3->{ \item \texttt{export CLASSPATH="build/classes/main:lib/*:build/lib/*:."}}
	\end{enumerate}
 \end{frame}
