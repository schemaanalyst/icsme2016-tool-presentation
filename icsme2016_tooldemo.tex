...
\setbeamercolor{frametitle}{fg=solarizedRebase1}
\setbeamercolor{framesubtitle}{fg=solarizedRebase1}
\setbeamercolor{author}{fg=solarizedRebase1}
\setbeamercolor{institute}{fg=solarizedRebase1}
\setbeamercolor{date}{fg=solarizedRebase1}

\setbeamercolor{normal text}{fg=solarizedRebase0}
